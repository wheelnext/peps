...
Variant metadata must feature a ``providers`` key. It corresponds to a
...
use variant providers.  Its set of keys MUST match the set of values in
the ``default-priorities.namespace`` list of variant metadata.
