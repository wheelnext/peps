...
published in the same indexes as the packages using them. Package indexes
SHOULD verify that packages published to the index only require variant
provider plugins available from that same index.
