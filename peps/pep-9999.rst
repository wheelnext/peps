...
to Python packages or is one of the `builtin providers`_. In the case
...
- ``builtin: bool``: Whether the provider is a builtin provider
...
Builtin providers are special providers that cannot be implemented
