...
The schema is specified per metadata file. Different wheels MAY use
different schema versions. Tools outputting variant metadata MAY convert
it to a different schema version.
