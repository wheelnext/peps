...
variant properties are compatible with the system, and use them to order
the wheels in the order of preference. This is done in addition to
determining the compatibility and ordering through tags. The ordering
by variant properties takes precedence over ordering by tags.
