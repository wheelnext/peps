...
Most of the definitions are borrowed from :pep:`440`.
...
`xgboost <https://xgboost.readthedocs.io/en/stable/install.html>`_ - NVIDIA CUDA accelerated, ``xgboost-cpu``). However,
...
not currently possible. :pep:`694` proposes adding such a mechanism for multiple
...
Variant properties are serialized into a structured 3-tuple format inspired by Trove Classiers from :pep:`301`.
