...
- SciPy wants to provide packages built against different BLAS
  libraries. It already ships wheels linked against different BLAS
  libraries on macOS, however they are not selectable by the user
  but keyed on different OS versions.
