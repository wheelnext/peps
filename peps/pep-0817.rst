...
<TODO> TL;DR; The system needs to expose system information for
variant decision / resolution to be taken.
...
<TODO> It would beneficial if the variant system was able to encode and resolve
...
<TODO> Integration inside the pylock.toml specification shall be considered
...
<TODO> Re-phrase & focus on "handled in a different place"
...
explicitly requires that untrusted provider plugin packages are never
